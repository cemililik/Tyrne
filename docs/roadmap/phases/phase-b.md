...
| ADR-0027 | Kernel virtual memory layout (B2 — identity-mapped MMU activation) | B2 (**Proposed 2026-05-08**) | was ADR-0025 in the pre-2026-04-27 plan; renumbered down by 2 because ADR-0025 (governance) and ADR-0026 (T-012 reservation) consumed slots. Drives [T-016](../../analysis/tasks/phase-b/T-016-mmu-activation.md) (Draft 2026-05-08). First ADR to apply [`write-adr` skill §Simulation](../../../.claude/skills/write-adr/SKILL.md) discipline forward (rather than retro-extracted as for ADR-0026 / ADR-0032). Companion architecture doc: [`docs/architecture/memory-management.md`](../../architecture/memory-management.md). |
