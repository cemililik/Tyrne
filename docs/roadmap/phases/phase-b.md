...
| ADR-0032 | Endpoint state rollback on `ipc_recv_and_yield` Deadlock + `ipc_cancel_recv` primitive | B2 prep (Proposed 2026-05-07) | new — drives [T-015](../../analysis/tasks/phase-b/T-015-endpoint-rollback-cancel-recv.md). Surfaced as Track A non-blocker in the [2026-05-06 comprehensive review](../../analysis/reviews/code-reviews/2026-05-06-full-tree-comprehensive.md) and a forward-flagged item in the [2026-05-07 B1 closure security review](../../analysis/reviews/security-reviews/2026-05-07-B1-closure.md). Non-blocking for ADR-0027; required before any B-phase task lands the first userspace-driven endpoint destroy. |
