...
- §Simulation row 3 (frame-budget + VA-range): `rejects_when_pmm_budget_exceeded`, `frame_budget_includes_root_plus_intermediates`, `rejects_image_base_va_past_userspace_va_limit`, `rejects_image_base_va_saturating_overflow`, `accepts_image_base_va_exactly_at_userspace_va_limit_minus_span`.
