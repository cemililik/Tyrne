...
| [`exceptions.md`](exceptions.md) | Exception vector table, IRQ dispatch, GIC v2 driver, generic-timer IRQ wiring, idle WFI activation. | Design (T-012 implementation in progress; doc lands ahead of code per B0 security review §8) |
