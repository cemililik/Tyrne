...
| [T-014](T-014-idle-dispatch-fallback.md) | Idle dispatch via separate fallback slot (closes B1 smoke regression; implements ADR-0026) | B1 | In Progress (2026-05-06) |
