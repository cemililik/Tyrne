...
| [T-012](T-012-exception-and-irq-infrastructure.md) | Exception infrastructure and interrupt delivery (GIC + IVT + timer-IRQ + idle-WFI) | B1 | In Progress (design-first 2026-04-28) |
