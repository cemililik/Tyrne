...
| 2026-04-28 | B1 closure consolidated pass (T-012 — GIC v2 + EL1 vector table + IRQ-handler dispatch + idle WFI; ADR-0021 2026-04-28 Amendment; UNSAFE-2026-0019/0020/0021 + UNSAFE-2026-0014 commit-`28c5ce9` Amendment) | Approve — no Yüksek findings; one forward-flagged non-blocking `arm_deadline` race only relevant when a future caller exists; pre-closure work-items (QEMU smoke + Miri) maintainer-side | [2026-04-28-B1-closure.md](2026-04-28-B1-closure.md) |
